module.exports = {
  dev: [
    ...
    { url: 'datagrid/server-driven', overlays: [{ x: 710, y: 1030, width: 40, height: 40 }] },
    ...
    { url: 'datepicker/datepicker-date-input-wrapper-present', overlays: [{ x: 260, y: 480, width: 360, height: 18 }] },
    'datepicker/disabled',
    ...
    { url: 'tree-view/lazy-recursive', overlays: [{ x: 252, y: 669, width: 24, height: 86 }] },
    ...
    // 'wizard/inline', // Must be last because the inline wizard blocks navigation
  ],
};
