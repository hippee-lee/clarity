    ...
    describe("Vertical Nav", () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [
                    NoIconsNoNavGroupTestComponent, IconsButNoNavGroupTestComponent, IconsAndNavGroupTestComponent,
                    OnlyNavGroupTestComponent, ViewBasicsTestComponent, APITestComponent,
        ...
        describe("Nav Internals - No Icons + No Nav Groups", () => {
            ...
            it("hides the .nav-links when the nav is collapsed", () => {
                ...
                const displayStyle: string = window.getComputedStyle(<HTMLElement>compiled.querySelector(".nav-link"))
        ...
        describe("Nav Internals - Only Nav Groups", () => {
            ...
            it("does not show .nav-group when nav is collapsed", () => {
                ...
                const displayStyle: string = window.getComputedStyle(<HTMLElement>compiled.querySelector(".nav-group"))
                                                 .getPropertyValue("display");
